...
public class Sysmodule   {
   ...
   private List<Sysmoduleaction> sysmoduleactionList;
   
   private List<Sysmodule> sysmoduleChilds;
   ...
   public void setModuleremark(String moduleremark ){
	...
	public List<Sysmoduleaction> getSysmoduleactionList() {
		return sysmoduleactionList;
	}

	public void setSysmoduleactionList(List<Sysmoduleaction> sysmoduleactionList) {
		this.sysmoduleactionList = sysmoduleactionList;
	}

	public List<Sysmodule> getSysmoduleChilds() {
		return sysmoduleChilds;
	}

	public void setSysmoduleChilds(List<Sysmodule> sysmoduleChilds) {
		this.sysmoduleChilds = sysmoduleChilds;
	}
