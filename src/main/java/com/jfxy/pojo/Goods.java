...
public class Goods {
	 ...
	 * 数据长度 0<br />
	 */
	private BigDecimal commissionnumber;
	/**
	 * 特价折扣 <br />
	 * 允许为空 YES <br />
	 * 数据长度 0<br />
	...
	/**
	   ...
	   private BigDecimal pointdiscount=new BigDecimal(0);
	 ...
	 */
	public BigDecimal getCommissionnumber() {
	 ...
	 */
	public void setCommissionnumber(BigDecimal commissionnumber) {
	...
	public BigDecimal getDiscountprice() {
		BigDecimal discountprice=this.price;
		if(null!=salepercet&&salepercet.doubleValue()>0){
			discountprice=price.multiply(salepercet);
		}
