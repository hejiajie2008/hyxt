...
public class Memlevel {
	 ...
	 * 数据长度 0<br />
	 */
	private Integer leveldiscountpercent;
	/**
	 * 积分率 <br />
	 * 允许为空 YES <br />
	 * 数据长度 0<br />
	...
	private List<GoodsClassRebat> goodsClassRabatList;
	 ...
	 */
	public Integer getLeveldiscountpercent() {
	 ...
	 */
	public void setLeveldiscountpercent(Integer leveldiscountpercent) {
	...
	public List<GoodsClassRebat> getGoodsClassRabatList() {
		return goodsClassRabatList;
	}

	public void setGoodsClassRabatList(List<GoodsClassRebat> goodsClassRabatList) {
		this.goodsClassRabatList = goodsClassRabatList;
	}
