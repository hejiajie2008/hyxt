...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center'">
		<form id="rbac-maps-edit-form" method="post" action="#">
				...
				<div title="基本信息" style="padding:10px">
					<table width="100%">
						...
						<tr>
							<td>图片地址</td>
							<td>
								<input name="jfphoto"  class="easyui-validatebox" data-options="required:true" style="width:100%"/>
							</td>
						</tr>
						...
						<tr>
							<td>所属店铺</td>
							<td>
								<input  id="edit_zydp" name="sid" style="width:150px"></input>
							</td>
						</tr>
					</table>
				</div>
	...
	<div data-options="region:'south',border:false" style="text-align: right; padding: 5px 0 0;">
		<a id="rbac-maps-edit-ok-button" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)">确定</a>
		<a id="rbac-maps-edit-cancel-button" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)">取消</a>
	</div>
</body>
</html>
